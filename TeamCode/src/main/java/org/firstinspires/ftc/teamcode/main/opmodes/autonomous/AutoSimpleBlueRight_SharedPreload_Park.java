...
@Config
@Autonomous(name = "🔵 ◢ Blue Right Auto Simple", group = "AutoSimple", preselectTeleOp = "Manual Drive")
public class AutoSimpleBlueRight_SharedPreload_Park extends AutoBase {
    @Override
