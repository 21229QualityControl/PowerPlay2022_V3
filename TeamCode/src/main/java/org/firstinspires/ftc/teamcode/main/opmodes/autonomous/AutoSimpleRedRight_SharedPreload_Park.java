...
@Config
@Autonomous(name = "🔴 ◢ Red Right Auto Simple", group = "AutoSimple", preselectTeleOp = "Manual Drive")
public class AutoSimpleRedRight_SharedPreload_Park extends AutoBase {
    @Override
