...
public class TrajectorySequenceBuilder {
    ...
    public TrajectorySequenceBuilder lineToRel(Vector2d relative) {
        return addPath(() -> lineTo(lastPose.vec().plus(relative)));
    }

    public TrajectorySequenceBuilder lineToRel(
            Vector2d relative,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.lineTo(lastPose.vec().plus(relative), velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToRelConstantHeading(Vector2d relative) {
        return addPath(() -> currentTrajectoryBuilder.lineToConstantHeading(lastPose.vec().plus(relative)));
    }

    public TrajectorySequenceBuilder lineToRelConstantHeading(
            Vector2d relative,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.lineToConstantHeading(lastPose.vec().plus(relative), velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToRelLinearHeading(Vector2d relative, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.lineToLinearHeading(new Pose2d(lastPose.vec().plus(relative), endHeading), currentVelConstraint, currentAccelConstraint));
    }

    public TrajectorySequenceBuilder lineToRelLinearHeading(
            Vector2d relative,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.lineToLinearHeading(new Pose2d(lastPose.vec().plus(relative), endHeading), velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder lineToRelSplineHeading(Vector2d relative, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.lineToSplineHeading(new Pose2d(lastPose.vec().plus(relative), endHeading), currentVelConstraint, currentAccelConstraint));
    }

    public TrajectorySequenceBuilder lineToRelSplineHeading(
            Vector2d relative,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.lineToSplineHeading(new Pose2d(lastPose.vec().plus(relative), endHeading), velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineTo(Pose2d endPose) {
        return addPath(() -> currentTrajectoryBuilder.splineTo(endPose.vec(), Angle.norm(endPose.getHeading()+tangentOffset), currentVelConstraint, currentAccelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineTo(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineTo(endPose.vec(), Angle.norm(endPose.getHeading()+tangentOffset), velConstraint, accelConstraint));
    }

    public TrajectorySequenceBuilder splineToRel(Pose2d relative) {
        return addPath(() -> currentTrajectoryBuilder.splineTo(lastPose.vec().plus(relative.vec()), Angle.norm(lastPose.getHeading()+relative.getHeading()+tangentOffset), currentVelConstraint, currentAccelConstraint));
    }

    public TrajectorySequenceBuilder splineToRel(
            Pose2d relative,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.splineTo(lastPose.vec().plus(relative.vec()), Angle.norm(lastPose.getHeading()+relative.getHeading()+tangentOffset), velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToRel(Vector2d relative, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineTo(lastPose.vec().plus(relative), endHeading, currentVelConstraint, currentAccelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToRel(
        ...
        return addPath(() -> currentTrajectoryBuilder.splineTo(lastPose.vec().plus(relative), endHeading, velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToRelConstantHeading(Vector2d relative, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineToConstantHeading(lastPose.vec().plus(relative), endHeading, currentVelConstraint, currentAccelConstraint));
    }

    public TrajectorySequenceBuilder splineToRelConstantHeading(
            Vector2d relative,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.splineToConstantHeading(lastPose.vec().plus(relative), endHeading, velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToRelLinearHeading(Pose2d relative, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineToLinearHeading(lastPose.plus(relative), endHeading, currentVelConstraint, currentAccelConstraint));
    }

    public TrajectorySequenceBuilder splineToRelLinearHeading(
            Pose2d relative,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.splineToLinearHeading(lastPose.plus(relative), endHeading, velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder splineToRelSplineHeading(Pose2d relative, double endHeading) {
        return addPath(() -> currentTrajectoryBuilder.splineToSplineHeading(lastPose.plus(relative), endHeading, currentVelConstraint, currentAccelConstraint));
    }

    public TrajectorySequenceBuilder splineToRelSplineHeading(
            Pose2d relative,
            double endHeading,
            TrajectoryVelocityConstraint velConstraint,
            TrajectoryAccelerationConstraint accelConstraint
    ) {
        return addPath(() -> currentTrajectoryBuilder.splineToSplineHeading(lastPose.plus(relative), endHeading, velConstraint, accelConstraint));
    }
    ...
    public TrajectorySequenceBuilder turnTo(double angle) {
        return turn(Angle.normDelta(angle - lastPose.getHeading()));
    }

    public TrajectorySequenceBuilder turnTo(double angle, double maxAngVel, double maxAngAccel) {
        return turn(Angle.normDelta(angle - lastPose.getHeading()), maxAngVel, maxAngAccel);
    }
    ...
    public TrajectorySequenceBuilder pushPath() {
        if (currentTrajectoryBuilder != null) {
            Trajectory builtTraj = currentTrajectoryBuilder.build();
