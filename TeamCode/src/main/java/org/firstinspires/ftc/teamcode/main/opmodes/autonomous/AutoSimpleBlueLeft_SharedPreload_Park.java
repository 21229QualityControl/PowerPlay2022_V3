...
@Config
@Autonomous(name = "🔵 ◣ Blue Left Auto Simple", group = "AutoSimple", preselectTeleOp = "Manual Drive")
public class AutoSimpleBlueLeft_SharedPreload_Park extends AutoBase {
    @Override
