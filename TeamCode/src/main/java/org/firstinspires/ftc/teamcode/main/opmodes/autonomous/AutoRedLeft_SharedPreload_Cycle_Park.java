...
@Config
@Autonomous(name = "🔴 ◣ Red Left Auto", group = "Auto", preselectTeleOp = "Manual Drive V2")
public class AutoRedLeft_SharedPreload_Cycle_Park extends AutoBase {
    public static CPose2d CYCLE_POSITION = new CPose2d(FieldConstants.redLeftConeStack.plus(new Vector2d(24, 1)), Math.toRadians(180));
    @Override
...
//        moveToJunction();
        ...
        for (int stack = 5; stack > 0; stack--) {
            if (getRuntime() < 23) {
                ...
                follow(auto.cycle(builder(CYCLE_POSITION.asPose2d()), 49, stack, this::getRuntime));
        ...
        follow(auto.sendLastCone(builder(CYCLE_POSITION.asPose2d()), 49));
